...
Original file is located at
    https://colab.research.google.com/drive/1ADT4bJnHv8q_qtCCY7XmtPYyNDXwg56K
"""
...
# Import all of them 
sales=pd.read_csv(io.BytesIO(uploaded['sales_train.csv']))

# settings
import warnings
warnings.filterwarnings("ignore")

item_cat=pd.read_csv(io.BytesIO(uploaded['item_categories.csv']))
item=pd.read_csv(io.BytesIO(uploaded['items.csv']))
